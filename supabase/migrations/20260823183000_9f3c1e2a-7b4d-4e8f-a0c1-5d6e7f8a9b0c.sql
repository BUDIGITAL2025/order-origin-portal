...
CREATE OR REPLACE FUNCTION public.submit_quote_request(p_product_url text, p_product_name text, p_notes text, p_target_monthly_volume integer, p_image_urls text[], p_supersedes_quote_id uuid, p_on_behalf_of uuid, p_target_countries text[], p_store_id uuid, p_preview_id uuid)
